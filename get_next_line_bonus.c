...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/08/16 23:35:00 by mnarazak          #+#    #+#             */
/*   Updated: 2020/08/16 23:38:22 by mnarazak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	get_next_line_main(char **s, char **line, int fd)
{
	char	*tmp;
...
int			get_next_line(const int fd, char **line)
{
	...
	if (fd < 0 || FOPEN_MAX <= fd || BUFFER_SIZE <= 0)
		return (ERROR);
	return (get_next_line_main(s, line, fd));
}
